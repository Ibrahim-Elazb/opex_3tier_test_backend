import { editEmployee, deleteEmployee, getEmployeeByID } from "../../../../data-access/employees";
...
export async function PATCH(request, { params }) {
    try {
        ...
        const result = await editEmployee({ employee_id, first_name, last_name, email, phone_number, hire_date, job, salary, department_id });
